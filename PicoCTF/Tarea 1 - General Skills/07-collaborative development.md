...
```
alestd-picoctf@webshell:~/drop-in$ wget https://artifacts.picoctf.net/c_titan/71/challenge.zip
--2025-03-14 03:05:22--  https://artifacts.picoctf.net/c_titan/71/challenge.zip
...
2025-03-14 03:05:22 (5.45 MB/s) - 'challenge.zip' saved [24467/24467]

alestd-picoctf@webshell:~/drop-in$ ls    
challenge.zip
alestd-picoctf@webshell:~/drop-in$ unzip challenge.zip
...
alestd-picoctf@webshell:~/drop-in$ cd drop-in/
alestd-picoctf@webshell:~/drop-in/drop-in$ ls
flag.py
alestd-picoctf@webshell:~/drop-in/drop-in$ cat flag.py
print("Printing the flag...")
alestd-picoctf@webshell:~/drop-in/drop-in$ git log

[5]+  Stopped                 git log
alestd-picoctf@webshell:~/drop-in/drop-in$ git flog
git: 'flog' is not a git command. See 'git --help'.

The most similar command is
        reflog
alestd-picoctf@webshell:~/drop-in/drop-in$ git reflog

[6]+  Stopped                 git reflog
alestd-picoctf@webshell:~/drop-in/drop-in$ git branch -a

[7]+  Stopped                 git branch -a
alestd-picoctf@webshell:~/drop-in/drop-in$ git chekout feature/part-1
git: 'chekout' is not a git command. See 'git --help'.

The most similar command is
        checkout
alestd-picoctf@webshell:~/drop-in/drop-in$ git checkout feature/part-1
Switched to branch 'feature/part-1'
alestd-picoctf@webshell:~/drop-in/drop-in$ cat flag.py
print("Printing the flag...")
print("picoCTF{t3@mw0rk_", end='')alestd-picoctf@webshell:~/drop-in/drop-in$ git checkout feature/part-2
Switched to branch 'feature/part-2'
alestd-picoctf@webshell:~/drop-in/drop-in$ cat flag.py
print("Printing the flag...")

print("m@k3s_th3_dr3@m_", end='')alestd-picoctf@webshell:~/drop-in/drop-in$ git checkout feature/part-3
